...
import org.hiedacamellia.watersource.common.item.*;
...
public class ItemRegistry {
    ...
    public final static RegistryObject<Item> WOODEN_CUP_DRINK = MOD_ITEMS.register("wooden_cup_drink", () -> new WoodenCupItem(new Item.Properties().stacksTo(1), 250));
    public final static RegistryObject<Item> LEATHER_WATER_BAG = MOD_ITEMS.register("leather_water_bag", () -> new LeatherWaterBagItem(new Item.Properties().stacksTo(1).setNoRepair(), 1500));
    public final static RegistryObject<Item> IRON_BOTTLE = MOD_ITEMS.register("iron_bottle", () -> new IronBottleItem(new Item.Properties().stacksTo(1).setNoRepair(), 1500));
