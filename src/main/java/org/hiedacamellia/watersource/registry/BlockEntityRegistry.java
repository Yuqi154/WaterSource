...
import org.hiedacamellia.watersource.common.block.entity.*;
...
public final class BlockEntityRegistry {
    public static final DeferredRegister<BlockEntityType<?>> MOD_BLOCK_ENTITIES = DeferredRegister.create(ForgeRegistries.BLOCK_ENTITY_TYPES, MODID);
