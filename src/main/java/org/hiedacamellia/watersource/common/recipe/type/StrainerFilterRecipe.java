package org.hiedacamellia.watersource.common.recipe.type;
    ...
    public boolean matches(CraftingContainer container, Level level) {
        ...
        if (f) {
            ...
            if (!containerItem.is(Items.POTION)) {
                IFluidHandlerItem fluidHandlerItem = containerItem.getCapability(ForgeCapabilities.FLUID_HANDLER_ITEM).orElse(null);
